...
__published:	// IDE-managed Components
	...
	TMenuItem *MergeSort1;
	TMenuItem *LimpiarMatriz1;
	TMenuItem *ModelosdeExamen1;
	TMenuItem *CargarunVectorconparesdeDigitosdeunnumero1;
	TMenuItem *Cargarunvectorconlosprimeros2caracteresdecadapalabradeunacadena1;
	TMenuItem *CargarunaMatrizdelasiguienteforma1;
	...
	void __fastcall MergeSort1Click(TObject *Sender);
	void __fastcall LimpiarMatriz1Click(TObject *Sender);
	void __fastcall CargarunVectorconparesdeDigitosdeunnumero1Click(TObject *Sender);
	void __fastcall Cargarunvectorconlosprimeros2caracteresdecadapalabradeunacadena1Click(TObject *Sender);
	void __fastcall CargarunaMatrizdelasiguienteforma1Click(TObject *Sender);
