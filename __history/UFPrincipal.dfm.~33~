object Form1: TForm1
  ...
  object MainMenu1: TMainMenu
    ...
    object ModelosdeExamen1: TMenuItem
      ...
      object CargarunVectorconparesdeDigitosdeunnumero1: TMenuItem
        Caption = 'Cargar un Vector con pares de Digitos de un numero '
        OnClick = CargarunVectorconparesdeDigitosdeunnumero1Click
      end
      object Cargarunvectorconlosprimeros2caracteresdecadapalabradeunacadena1: TMenuItem
        Caption = 
          'Cargar un vector con los primeros 2 caracteres de cada palabra d' +
          'e una cadena'
        OnClick = Cargarunvectorconlosprimeros2caracteresdecadapalabradeunacadena1Click
      end
      object CargarunaMatrizdelasiguienteforma1: TMenuItem
        Caption = 'Cargar una Matriz de la siguiente forma..'
        OnClick = CargarunaMatrizdelasiguienteforma1Click
      end
    end
    object RetoCeleste1: TMenuItem
      Caption = 'Reto Celeste'
      OnClick = RetoCeleste1Click
      object Prueba11: TMenuItem
        Caption = 'Prueba 1'
        OnClick = Prueba11Click
      end
      object Prueba21: TMenuItem
        Caption = 'Prueba 2'
        OnClick = Prueba21Click
      end
    end
  end
end
